 ...
 * Авторские права 2011-2024 принадлежат авторам Bootstrap
...
(() => {
  ...
  константа setTheme = тема => {
    если (тема === 'авто') {
      document.documentElement.setAttribute('data-bs-theme', (window.matchMedia('(prefers-color-scheme: dark)').соответствует ? 'dark' : 'light'))
    } еще {
